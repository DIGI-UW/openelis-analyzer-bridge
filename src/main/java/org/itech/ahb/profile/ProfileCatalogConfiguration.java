...
public class ProfileCatalogConfiguration {
  ...
  @Bean
  public PortableProfileCatalog portableProfileCatalog(
    ...
    var shippedProfiles = Arrays.stream(resources).sorted(Comparator.comparing(Resource::getDescription)).toList();
    return new PortableProfileCatalog(
