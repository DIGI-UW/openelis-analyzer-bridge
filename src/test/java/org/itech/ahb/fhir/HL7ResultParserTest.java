...
class HL7ResultParserTest {
  ...
  @Test
  void sendingApplicationUsesHeaderSeparatorsAndDoesNotAppendFacility() {
    assertEquals("APP", HL7ResultParser.sendingApplication("MSH|^~\\&|APP^OID|FACILITY|OE|LAB\rPID|1\r"));
    assertEquals(
      "APP-WITH-HYPHEN",
      HL7ResultParser.sendingApplication("MSH*$%!@*APP-WITH-HYPHEN$OID*FACILITY*OE*LAB\r")
    );
    assertNull(HL7ResultParser.sendingApplication("MSH|^~\\&||FACILITY|OE|LAB\r"));
    assertNull(HL7ResultParser.sendingApplication("OBX|1|NM|TEST||1\r"));
    assertEquals("FIRST", HL7ResultParser.sendingApplication("MSH|^~\\&|FIRST|LAB\rMSH|^~\\&|SECOND|LAB\r"));
  }
  ...
  class ValidMessage {
    ...
    void shouldExtractTestCodes() {
      ...
      assertNotNull(parsed);
      List<String> codes = parsed.results().stream().map(AnalyzerResult::testCode).toList();
    ...
    void shouldExtractValues() {
      ...
      assertNotNull(parsed);
      List<String> values = parsed.results().stream().map(AnalyzerResult::value).toList();
  ...
  class TestCodeExtraction {
    ...
    void simpleFormatExtractsComponent1() {
      String msg =
        "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1||ACC001|CBC\r" + "OBX|1|NM|WBC||5.0|10*3/uL\r";
  ...
  class AccessionExtraction {
    ...
    void fallbackToPlacerWhenFillerEmpty() {
      String msg =
        "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1|PLACER999||CBC\r" + "OBX|1|NM|WBC||5.0|10*3/uL\r";
    ...
    void unknownWhenNoAccessionSource() {
      String msg = "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1|||CBC\r" + "OBX|1|NM|WBC||5.0|10*3/uL\r";
  ...
  class ValueTypeDetection {
    ...
    void numericTypeDetected() {
      String msg =
        "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1||ACC001|CBC\r" + "OBX|1|NM|WBC||7.5|10*3/uL\r";
    ...
    void stringTypeDetected() {
      String msg =
        "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1||ACC001|CBC\r" + "OBX|1|ST|INTERP||Normal|\r";
    ...
    void structuredNumericTypeDetected() {
      String msg =
        "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1||ACC001|CBC\r" + "OBX|1|SN|RATIO||1.5|ratio\r";
  ...
  class EdgeCases {
    ...
    void noObxReturnsNull() {
      String msg = "MSH|^~\\&|A|B|C|D|20260326||ORU^R01|1|P|2.3.1\r" + "OBR|1||ACC001|CBC\r";
