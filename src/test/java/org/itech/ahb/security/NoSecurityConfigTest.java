...
/**
 * Integration tests for disabled security configuration (bridge.security.enabled=false).
 * <p>
 * Verifies that when security is disabled, the /input endpoint is accessible
...
class NoSecurityConfigTest {
    ...
    @Test
    @DisplayName("Unauthenticated POST to /input succeeds when security is disabled")
